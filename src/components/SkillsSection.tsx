...
const SkillsSection: React.FC = () => {
  ...
  const technicalSkills = [
    ...
    { id: 12, name: 'Figma', image: '/images/figma.svg' },
    { id: 13, name: 'Illustrator', image: '/images/adobe-ilustrator.svg' },
    { id: 14, name: 'Photoshop', image: '/images/photoshop.svg' },
    { id: 15, name: 'Machine-learning', image: '/images/machine-learning.svg' },
  ];
